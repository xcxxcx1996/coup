...
func (a DrawCoin) Start(dispatcher runtime.MatchDispatcher, message runtime.MatchData, state *model.MatchState) (err error) {
	...
	info := fmt.Sprintf(`<p><span style="color:red;">%v</span> want to <span style="color:green;">gain %v coins</span>.</p >`, a.message.GetUsername(), a.coins)
...
func (a DrawCoin) AfterDeny(dispatcher runtime.MatchDispatcher, state *model.MatchState) (err error) {
	...
	info := fmt.Sprintf(`<p><span style="color:red;">%v</span> success <span style="color:red;"> gain %v coins</span>.</p >`, a.message.GetUsername(), a.coins)
	SendNotification(info, dispatcher)
	return
}
